...
describe ThirdSocialMediaController do
  ...
  let(:current_user_json) {%Q({"_id" : "56df404993a9a845256d305d",
                            "provider" :"local",
                            "name" : "Louise",
  ...
  #VERIFY why the JSON file is pending slashes
  ...
  it "should export my data to JSON format when I enter my credentials" do
   ...
   #TODO:VERIFY why the JSON file is  adding slashes
    #expect(response.body).to include(current_user_json)
